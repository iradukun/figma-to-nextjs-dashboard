...
const recentLeads: Lead[] = [
  {
    ...
    image: '/download.jpeg?height=40&width=40'
  },
  {
    name: 'Devon Lane',
    email: 'dat.roberts@example.com',
    image: '/picture.jpeg?height=40&width=40'
  },
  {
    name: 'Jane Cooper',
    email: 'jgraham@example.com',
    image: '/local.jpeg?height=40&width=40'
  },
  {
    name: 'Dianne Russell',
    email: 'curtis.d@example.com',
    image: '/release.jpeg?height=40&width=40'
  }
]
                  ...
                  <tbody>
                    {campaigns.map((campaign, index) => (
                      <tr key={index} className='border-b border-gray-200'>
                        ...
                        <td className='py-4 pr-6 text-sm text-[#00B8D9]'>
                          {campaign.leads}
                        </td>
                        <td className='py-4'>
                          <div className='flex items-center gap-2'>
